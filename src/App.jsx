      ...
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 
       text-orange-500 bg-gray-700'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button onClick={copyPasswaordToClipboard} className='outline-none 
           bg-blue-700 text-cyan-50 px-3 py-0.5 shrink-0'>Copy</button>
        </div>
...
{/* <h1>Pankaj 2 Vite React Project !</h1>
